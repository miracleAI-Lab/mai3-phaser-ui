import { DialogBody, DialogFooter, DialogHeader, Mai3Component } from '@/mai3/types';
import { Dialog } from '../mai3/gui/Dialog';
import BaseScene from '../mai3/scene';
