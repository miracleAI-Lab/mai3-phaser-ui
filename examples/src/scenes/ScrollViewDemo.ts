...
export class ScrollViewDemo extends BaseScene {
  private dialog!: Dialog;
  private goodImageIds: string[] = [];
  constructor() {
    super("ScrollViewDemo");
  }
    ...
    this.dialog.addItems([
      {
        ...
        showScrollbar: false,
        type: "ScrollView",
        childConfigs: this.createScrollViewItems(),
      },
    ]);
  ...
  private createScrollViewItems(): BaseConfig[] {
    const cellItems: any[] = [];
    ...
    for (let row = 0; row < 100; row++) {
      ...
      if (row % 4 === 2) {
        ...
        cellItems[row].childConfigs.push({
          id: id,
          type: "Image",
          key: "l-good",
          width: 62,
